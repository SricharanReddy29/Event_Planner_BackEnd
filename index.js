...
const mongoClient = new MongoClient("mongodb+srv://EventPlanner:%40Eventplanner@eventplanner.oir2xzw.mongodb.net/");
app.use(cors());
...
app.get('/api/data', async (req, res) => {
  try {
    ...
    const collection = client.db('event').collection('venuedetails'); // Replace with your collection name
